...
public class PaymentNetwork {
    ...
    public PaymentNetworkType getPaymentNetworkType() {
        return paymentNetworkType;
    }

    public void setPaymentNetworkType(
        PaymentNetworkType paymentNetworkType
    ) {
        this.paymentNetworkType = paymentNetworkType;
    }
